...
What is the problem you want to solve?
    ...
    Identify the job trend in San Francisco using the transparent data system of the state.
    Identify jobs (titles) that have increased/decreased from the past.
    Identify the trend of pay packages for demanding/non demanding jobs over the past.
